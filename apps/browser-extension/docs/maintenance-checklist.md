# Contrat De Stabilite - StreamVolume Guard Hub
...
- `localhost` et `127.0.0.1` doivent garder Stream par défaut pour le contrat de test local, sans bloquer les changements de profil explicites ;
...
$env:WLG_EXTENSION_DIR="chemin vers StreamVolume Guard Hub\dist\chromium"
node tests/browser-smoke.js
git diff --check
graphify update .
```
